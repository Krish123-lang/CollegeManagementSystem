...
def draw_login_page():
    ...
    #heading label
    nsec=Label(header, text="Adarsha Secondary School",font=("Helvetica",16,"bold"), bg = "#e23946",fg="#eae2b7")
...
def draw_visitor():
    ...
    image1 = Image.open("media/adarsha.jpg")
...
#logo
image1 = Image.open("media/lohho.png")
test = ImageTk.PhotoImage(image1)
label1 = tkinter.Label(header,image=test)
label1.image = test
label1.place(x=0, y=0, height = 120)
#heading label
nsec=Label(header, text="Adarsha Secondary School",font=("Helvetica",36,"bold"), bg = "brown",fg="#eae2b7")
